...
const abilities = {
    superSpeed: {
        cooldown: 0,
        maxCooldown: 15000, // 15 секунд
        duration: 0,
        maxDuration: 10000, // 10 секунд
        active: false
    },
    fly: {
        cooldown: 0,
        maxCooldown: 20000, // 20 секунд
        duration: 0,
...
function activateSuperSpeed() {
    if (abilities.superSpeed.cooldown <= 0 && !abilities.superSpeed.active) {
        ...
        player.baseSpeed = 12; // 3 раза быстрей
...
console.log('Управление: Стрелки или WASD');
console.log('Способности: Q - Супер бег, W - Полёт, E - Силач');
